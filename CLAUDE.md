...
- **CI:** `tests/test_emerge2{1,3,4,5,6,7,8,9}_*.py` + `test_emerge3{0,1,2,3,4,5,6,7}_*.py` + the competitive-self-organizing-pooler + discovered-multi-level-taxonomy arc `test_emerge{38..49}_*.py` (28 `test_emerge*` files, CPU/numpy, offline; see the 2026-07-02 competitive-pooler arc note below).
