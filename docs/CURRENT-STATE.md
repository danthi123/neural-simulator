...
baseline because the receipt wrapper cannot honor the envelope's old-source
working directory. The next action is a process-only continuation that reuses
sealed V6 physiology and completes performance without rerunning consumed
seeds. Stage-1 remains sealed.
