...
CPU seed is consumed, and the observation has diagnostic value only. The next
action is to freeze process correction v2 with explicit dual digests, sidecar
sealing, and fresh mechanically derived calibration and replication partitions.
Held-out and Stage-1 seeds remain sealed.
