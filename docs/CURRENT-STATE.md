...
| **Stage B experiment screening** | The V14 engine completed a fresh 512-candidate, five-arm GPU engineering screen for Sobol indices 512-1023 and selected batch width 512 through a separate benchmark. Strict triage classified 421 candidates as engineering failures, 91 as inconclusive, and 0 as passes. A new digest-bound supervisor can authenticate and resume existing receipts, advance one deterministic GPU batch, and run strict triage after completion. | This is engineering evidence only. No candidate is eligible for NumPy/CPU confirmation, the biological contracts remain unresolved, candidates 284 and 404 remain closed, and the heterogeneous 12-cell SK cohort is unavailable. The supervisor is not a daemon or automatic search/confirmation loop. See the [fresh V3 screen finding](../research/findings/2026-08-05-v14-stageB-sobol-v3-fresh-gpu-screen-ENGINEERING-NO-GO.md). |
