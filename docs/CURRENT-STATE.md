...
policy learning remains closed. The next evidence gate must establish a neural
action boundary: commitment, termination, refractory state, or corollary
discharge that preserves one completed action without Python stopping the trial
after observing a winner.
