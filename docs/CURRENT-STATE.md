...
critic activity becomes extreme. The first dendritic-expectation successor
passes seed-zero NumPy smoke but exceeds its firing bound on CuPy, so its
scientific seeds stay sealed while the backend disagreement is localized.
