...
**Score: 40 BLOCKING · 1 structural · 9 reporting · 0 ungated — 50 rows.** (The previous line read
...
row Y, green but non-blocking, was in no bucket. This session's **FM** row (BLOCKS) makes it 39 · 1 · 9 — 49, and the 2026-09-23 **SN** row (BLOCKS) makes it 40 · 1 · 9 — 50,
re-derived the same way: `grep '^| ' docs/FAILURE_GATE_MATRIX.md | awk -F'|' '{print $(NF-1)}'` tabulated to
39 BLOCKS-family + 1 STRUCTURAL + 9 reporting-family (8 yellow + the 1 anomalous green REPORTS row Y) = 49.)
