...
**Score: 28 BLOCKING · 1 structural · 8 reporting · 0 ungated — 37 rows.** (The previous line read
`27 · 1 · 7 — 35`; +BS (BLOCKS) +TH (🟡 REPORTS) = 37. Re-derived, not incremented, per the rule below. An
