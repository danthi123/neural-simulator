...
**Score: 30 BLOCKING · 1 structural · 8 reporting · 0 ungated — 39 rows.** (The previous line read
`29 · 1 · 8 — 38`; +CH (BLOCKS) = 39. Re-derived, not incremented, per the rule below. An
earlier line read `14 · 1 · 6`, which summed to 21 against 22 rows: row **Y**, green but non-blocking, was in
no bucket. Reporting = 7 🟡 rows + Y.)
