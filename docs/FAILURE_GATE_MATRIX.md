...
**Score: 29 BLOCKING · 1 structural · 8 reporting · 0 ungated — 38 rows.** (The previous line read
`28 · 1 · 8 — 37`; +OS (BLOCKS) = 38. Re-derived, not incremented, per the rule below. An
