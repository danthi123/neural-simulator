...
# --- Stimulus/Experiment Dataclasses (extracted to sim/config.py) ---
# StimulusPattern, StimulusChannel, NeuronGroup, ReadoutConfig, TrainingConfig,
# ExperimentPhase, ExperimentConfig imported from sim.config
