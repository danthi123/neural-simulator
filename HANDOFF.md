...
```bash
.venv-rag/bin/python tools/rag/rag_search.py "<question>" 5 --corpus finding
...
.venv-rag/bin/python tools/rag/rag_search.py "<question>" 5 --corpus finding   # our own conclusions first
