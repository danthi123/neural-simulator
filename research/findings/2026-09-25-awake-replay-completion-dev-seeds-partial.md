...
prereg: research/findings/2026-09-24-sleep-replay-capture-PREREGISTRATION.md (Amendment 8, commit a34593b0d, after
...
seed-waiver: development seeds only, by design; none of the six gate seeds (42/43/44/100/101/102) was built by this
  arc. This finding makes no generalization claim; the six-seed test is Amendment 8's `arcc` family, prepared and
  not run.
...
verdict: DEV CHECK (not a gate row, not a GO): on the two weak dev seeds of fifteen (2 and 13, fresh reads 0.16 and
  ...
  needed on a seed whose margin route collapses deeper -- as gate seed 101's did -- is not answered here; Amendment 8
...
have -- cannot be read from these dev seeds; Amendment 8 therefore registers the two one-route arms as REPORTED
...
Amendment 8 of the prereg (commit `a34593b0d`, after this finding and before any gate-seed run) registers the `arcc`
...
not contain `origin/main`, see Amendment 8's compute section if `main` has moved):
