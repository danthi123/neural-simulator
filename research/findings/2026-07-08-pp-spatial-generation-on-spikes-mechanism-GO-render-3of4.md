...
**Verdict:** GO (4/4, seed 42) — PP spatial generation on spikes: order + productive morphology + prepositions + moat, render-fidelity 4/4. The initial 3/4 miss (the EMERGE-75b A→W read-path residual) was **SURPASSED** by a larger pre-spell settling window (reset_steps 50→150).
