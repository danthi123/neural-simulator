...
<!--derived-->
`d3w_shy_a`'s own increment-to-baseline ratio at recall is *lower* on seeds 43 (0.6337) and 101 (0.6548) than on <!--derived: inc_mag / base_mag at recall, per seed artifact-->
any of the four P2-holding seeds (0.7364-0.9978), yet `d3w_rc` (no downscaling at all) still reads `abstain` on <!--derived: inc_mag / base_mag at recall, per seed artifact-->
those two while its own ratio is 1.0842 (43) and 1.1488 (101) -- both *above* 1.0, i.e. the fact's synaptic trace <!--derived: inc_mag / base_mag at recall, per seed artifact-->
