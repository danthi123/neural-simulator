...
| 2026-04-28 | [Cheat #5 v4 — developmental pretraining](2026-04-28-cheat5-v4-results.md) | **NO-GO; cheat #5 closed by design** — v4 (5K pretraining + freeze) is *worse* than v3.1: 3-seed 11.34 ± 1.85, P0 4.88, P1 6.46. Tier 3 skipped (Tier 2 unanimous past >6 NO-GO). Cross-projections off-axis at this level of abstraction; v3 MSN lateral inhibition IS the functional WTA. Real BG dense + same-action-dominant = our model's same-action-only + lateral inhibition. |
