...
|------|---------|---------|
| 2026-04-28 | [Cheat #5 v1 — Curriculum-Staged Cross-Projections](2026-04-28-cheat5-v1-NEGATIVE.md) | **NEGATIVE** — 3-seed mean sum 10.87 vs baseline 5.88. Stopped early; signal unambiguous. Diagnosis: plasticity gate freezes learning but not synaptic transmission, so cross-projection synapses with weight=5.0 disrupt BG disinhibition from step 0. v2 will use weight=0.0 init + thaw-time ramp. |
| 2026-04-27/28 | [**🎉🎉🎉🎉 NEW BEST: 4 of 5 Cheats Closed**](2026-04-27-NEW-BEST-4cheats-closed.md) | **GO (CURRENT FLAGSHIP)** — claimed 6/6 seeds, sum 4.08 vs baseline 5.88, **p=0.00045**. **⚠ DATA DISCREPANCY (2026-04-28):** the per-seed values reported in this finding match `_sensedonly.json` files for seeds 42/100/101/102 only; the `_allnocheats.json` files committed alongside (seeds 42/43/44 only) show sums of 9.00/7.20/9.00. Under investigation. |
