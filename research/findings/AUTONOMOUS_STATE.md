...
## >>> EXACT NEXT (2026-06-09 — N9 ROOT CAUSE = CuPy-vs-numpy FIRING-MARGIN divergence (critic fires on CPU, silent on GPU); plastic-mask fix LANDED; read THIS FIRST; supersedes every block below) <<<
