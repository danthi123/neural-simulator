...
## >>> CURRENT STATUS (2026-06-05 ~07:10, NEWEST — read THIS first): (B) opponency linear-glue — NEF integrator NEGATIVE; pivoted to research Option B (bipolar threshold / per-dim spiking WTA); cheap-first numpy GO, spiking WTA w_opp-hardening sweep IN FLIGHT <<<
