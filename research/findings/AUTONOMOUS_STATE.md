...
## >>> EXACT NEXT (2026-06-09 — PLACE-CODE biologization: Stage 1 PASS (self-org place code position-specific on CuPy); Stage 2 (sparse-read critic grading) IN FLIGHT; read THIS FIRST; supersedes every block below) <<<
