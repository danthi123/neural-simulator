...
## >>> EXACT NEXT (2026-06-09 — exc_receptor sim/ edit LANDED+validated `069d3023`; 1st de-risk was a SILENT-CA3 artifact (feedforward didn't conduct, NOT a mechanism test); fix (drive CA3 via validated Stage-1) + re-test IN FLIGHT; read THIS FIRST; supersedes every block below) <<<
