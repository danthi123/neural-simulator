...
## >>> CURRENT STATUS (2026-06-06, NEWEST — read THIS first; supersedes every block below): graded-LGN decorrelation build = BOUNDARY (multi-seed, REVIEWED+VERIFIED+PUSHED); owner-confirmed 4-step sim-wide roadmap; AWAITING owner A/B fork <<<
