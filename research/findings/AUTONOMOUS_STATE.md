...
## >>> EXACT NEXT (2026-06-09 — N9 value machinery BIOLOGIZED on CuPy (FIRE+LEARN+ACTOR 3/3); BLOCKED on place-grading → next biologize the PLACE CODE (neural place cells); read THIS FIRST; supersedes every block below) <<<
