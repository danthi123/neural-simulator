...
- TRUE accuracy: [0.16, 0.13, 0.21] (mean 16.7%)
- Best permutation accuracy: [0.39, 0.37, 0.38] (mean 38.0%)
- North-South inversion present in 1/3 seeds
  (north->S rate > 30% AND south->N rate > 30%)
- E-as-sink (>= 2 words mapping to E): 1/3 seeds
