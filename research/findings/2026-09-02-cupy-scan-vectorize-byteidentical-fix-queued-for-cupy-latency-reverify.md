...
Artifacts: `research/findings/raw/_cupy_scan_vectorize/byteident.txt` (human-readable log) +
`research/findings/raw/_cupy_scan_vectorize/byteident.json` (structured per-seed counts, same run)
