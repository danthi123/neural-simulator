...
def main():
    ...
    ap.add_argument("--plateau-self-regen", type=float, default=0.0, help="v-gated self-regenerating plateau sustain (bistable dendrite)")
    ap.add_argument("--apical-kir-g", type=float, default=0.0, help="KIR down-state stabilizer conductance")
    ...
    for s in seeds:
        r = run(s, n_ca3=a.n_ca3, assembly_frac=a.assembly_frac, ca3_density=a.ca3_density, bistable=True,
                ...
                structural_sep=a.structural_sep, plateau_self_regen=a.plateau_self_regen, apical_kir_g=a.apical_kir_g,
