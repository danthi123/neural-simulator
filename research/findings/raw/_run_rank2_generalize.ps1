...
$common = @(
  "--moving-goal","--goal-schedule","generalize","--deterministic",
...
foreach ($seed in @(42, 43, 44)) {
  ...
  python -m research.runners.g11_bg_runner @common --seed $seed --out "research/findings/raw/_rank2_generalize_s$seed.json"
}
