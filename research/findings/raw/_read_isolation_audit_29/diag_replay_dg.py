...
# also test _dg_engram repeat
e1 = _dg_engram(bridge, cfg, regions, inputs["m0"], True)
e2 = _dg_engram(bridge, cfg, regions, inputs["m0"], True)
eng_identical = np.array_equal(e1, e2)
...
print(json.dumps({
    ...
    "dg_engram_repeat_identical": eng_identical,
}, indent=2))
