...
current_finding: research/findings/2026-08-26-inductive-coverage-premise-diversity-6seed-PARTIAL.md
current_status: "6-seed (42/43/44/100/101/102, numpy) verdict = PARTIAL (runner's own). The COVERAGE effect (diverse-2 > within-2 at MATCHED premise count) is robust -- +0.0530 median, POSITIVE in all 6/6 seeds, diverse>within>1-premise every seed -- and the premise-lesion anti-cheat collapses to +0.0000 every seed. It EMERGES from the substrate's own soft-bound Hebbian saturation (a synaptic form of the Ch-17 normalization companion process): diverse premises spread potentiation across more subcategory cores, and because w after 2 co-activations < 2x w after 1 (soft-bound concavity), spreading beats concentrating. No host similarity formula: readout is the property region's graded population depolarization through the LEARNED concept->property synapses. NOT yet a GO: the permuted-code anti-cheat collapses in ORDERING but retains a ~13% median magnitude residual above the runner's 10% floor (a selectivity residual, likely global potentiation of the taught-block afferents), so ac1_ok=False -> PARTIAL."
sources:
...
findings:
  - research/findings/2026-08-26-inductive-coverage-premise-diversity-6seed-PARTIAL.md
---
