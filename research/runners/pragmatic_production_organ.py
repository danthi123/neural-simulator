...
def get_organ(seed: int = 42) -> PragmaticProductionOrgan:
    ...
    if _ORGAN is None:
        ...
        # point). None (wave3=0, the escape) -> fall back to the SINGLE-POOL merge (default-ON) -> the pool-#2 pairwise
        # path -> byte-identical to before the flip. pragmatic is in every pool -> min_wave=1.
