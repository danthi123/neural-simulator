...
def main():
    ...
    ap.add_argument("--ca1-ff-inhib", type=float, default=None, help="CA1 FEEDFORWARD inhibition weight (ca3->ca1_pv_basket->ca1) = divisive normalization -> ~constant sparse ca1 FRACTION across drive magnitudes (the research-grounded robust 6/6 lever, vs the ca1-fb-inhib knife-edge)")
    ...
    kw = dict(n_ca3=a.n_ca3, n_assembly=a.n_assembly, presentations=a.presentations, schaffer_boost=a.schaffer_boost,
              ...
              ca1_fb_inhib=a.ca1_fb_inhib, replay_drive=a.replay_drive, ca1_ff_inhib=a.ca1_ff_inhib)
    if a.n_replay > 0:
