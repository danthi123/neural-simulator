...
def main():
    ...
    import json
    summary = {
        "bundle": a.bundle, "seeds": seeds,
        "n_seeds_total_answer_mismatches": sum(r["n_answer_mismatches"] for r in per_seed.values()),
        "n_seeds_total_scanidx_mismatches": sum(r["n_scanidx_mismatches"] for r in per_seed.values()),
        "n_seeds_total_answers_compared": sum(r["n_answers_compared"] for r in per_seed.values()),
        "n_seeds_total_scanidx_compared": sum(r["n_scanidx_compared"] for r in per_seed.values()),
        "per_seed": per_seed,
        "all_identical": all_identical,
        "elapsed_s": elapsed,
        "GO": all_identical,
        "verdict": "byte-identical" if all_identical else "DIVERGED",
    }
