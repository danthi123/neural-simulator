"""compose_engram_demo for v17 (extended-vocab) bridges.

Monkey-patches concept_pool_demo's vocab tables BEFORE delegating to
compose_engram_demo's main(). The bridge skeleton then includes all
28 pools, matching the v17 checkpoint.
"""
from __future__ import annotations
import research.runners.concept_pool_demo as cpd_v1

# Extended vocab (must match concept_pool_demo_v2.py)
NOUN_VOCAB = {
...
# Now import and delegate to compose_engram_demo's main()
import research.runners.compose_engram_demo as ced
