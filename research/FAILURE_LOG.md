...
| 2026-07-31 | CPU lanes sat 194 min unserved while the heartbeat correctly alarmed every 15 min — a TRUE alarm ignored because it only reports | `NOT-GATEABLE: staging work is judgement about WHAT to run. lane_check alarms correctly; the failure was mine in reading past it. Candidate: escalate to blocking after N consecutive starved cycles.` |
