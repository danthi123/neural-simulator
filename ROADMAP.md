...
Findings (this batch, part 3): `2026-08-27-graded-recall-instrument-learn-through-use-NOGO` (the graded-instrument fix named above: verified graded, converts the prior ceiling artifact into a real, lesion-controlled substrate negative).
