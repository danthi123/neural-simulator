...
This roadmap is the **status** surface. The detailed, forward-looking **plan** — the ordered burn-down of the temporary stand-ins in §8, the critical path to a single co-resident spiking brain, the decision points for when to spend more compute, and the honest time estimates — lives in `docs/plans/2026-07-15-months-scale-plan-to-one-brain-and-small-llm-conversation.md`.
